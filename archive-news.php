    ...
    <div class="px-4 lg:px-28 lg:mx-auto">
        <div class="py-7 lg:py-10">
            <div class="flex items-center mb-4 lg:px-0">
                ...
                <a class="text-xs VazirmatnBold text-secondry-500" href="#">اخبار</a>
            </div>
...
<div id="tab1Content" style="display: block;">
    ...
    >
        ...
        <div
            id="animated"
            class="animated border border-pirmary-300 rounded p-2 lg:p-4"
        >
            <div class="h-5/6 bg-cover bg-no-repeat">
                ...
                ></div>
                <p class="pt-3 text-sm transition-all duration-300">
                    <?php the_title(); ?>
                </p>
            </div>
    ...
    >
        ...
        <a
            class="flex px-2 justify-center items-center border rounded border-primary-700 focus:bg-secondry-500 focus:border-secondry-500 focus:text-white text-primary-700"
            href="<?php echo $link; ?>"
        ></a
      <?php endforeach; } ?>
    </div>
