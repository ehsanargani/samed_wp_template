...
<section class="relative">
    <div class="px-4 lg:px-0 sm:container mx-auto">
        ...
        <div class="pb-5 border-b border-primary-200">
            <h1 class="text-xl lg:text-2xl VazirmatnBold mb-2"><?php single_cat_title(); ?></h1>
        ...
        >
            <?php $query = new wp_Query(array('cat' => get_query_var('cat'),'posts_per_page'=>8,'paged' => $paged) ); ?>
